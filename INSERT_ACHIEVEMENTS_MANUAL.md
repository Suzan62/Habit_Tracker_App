# Manual Achievement Data Insertion

Since we couldn't run the automated SQL script, you can manually insert the achievements data by connecting to your PostgreSQL database and running these commands:

## Option 1: Using pgAdmin or any PostgreSQL client

Connect to your `HabitTrackerDB` database and execute the following SQL:
...
## Option 2: Using Entity Framework in your code

You can also add this data through your API by creating a seeding method or by making API calls to create achievements.

## Verification

After inserting the data, you can verify it was inserted correctly by running:

```sql
SELECT COUNT(*) FROM "Achievements";
```

This should return 22 achievements.

## Connection Details

Based on your `appsettings.json`, your database connection is:
- **Host**: localhost
